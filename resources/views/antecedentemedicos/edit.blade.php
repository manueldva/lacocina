...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@if($show == 1) Ver @else Editar @endif Antecedente Medico</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="{{ route('antecedentemedicos.update',$antecedentemedico->id) }}" method="POST">
            @csrf
            @method('PUT')
              <div class="row">
                <div class="col-md-12">
                      ...
                      <div class="card-header">
                        ...
                        <div class="row justify-content-center align-items-center">
                          @if($show == 0)
                            ...
                            &nbsp; &nbsp; 
                            <div class="form-group">
                              <a class="btn btn-outline-info" href="{{ route('antecedentemedicos.create') }}"><i class="fas fa-plus"></i> Nuevo</a>
                            </div>
                            @endcan
                          @endif
                          &nbsp; &nbsp; 
                    ...
                    <!-- form start -->
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" value="{{ $antecedentemedico->descripcion }}">
                        </div>
                        @error('descripcion')
                        ...
                        <div class="form-group">
                          ...
                          <select  id="tipoantecedentemedico_id" name="tipoantecedentemedico_id" class="form-control  @error('tipoantecedentemedico_id') is-invalid @enderror">
                            ...
                            @foreach($tipoantecedentemedicos as $tipo)
                              <option value="{{ $tipo->id }}" {{ $antecedentemedico->tipoantecedentemedico_id == $tipo->id ? 'selected' : '' }} >{{ $tipo->descripcion }}</option>
                            @endforeach
                        </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select  id="activo" name="activo" class="form-control  @error('activo') is-invalid @enderror">
                            <option value="1" {{ $antecedentemedico->activo == '1' ? 'selected' : '' }}>Activo</option>
                            <option value="0" {{ $antecedentemedico->activo == '0' ? 'selected' : '' }}>Inactivo</option>
                        </select>
                        </div>
                        @error('activo')
                          <div class="alert alert-info" role="alert">
