...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Listado de Calles</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body  p-3">
                <!--<div class="card-body p-0">-->
                         ...
                         <td>
                            <center>
                              @can('complementos.show')  
                                <a class="btn btn-sm btn-flat btn-outline-info" href="{{ route('calles.show',$calle->id) }}" data-toggle="tooltip" data-placement="top" title="Ver Datos"><i class="fas fa-eye"></i> </a>
                              @endcan
                              @can('complementos.edit')  
                                <a class="btn btn-sm btn-flat btn-outline-secondary" href="{{ route('calles.edit',$calle->id) }}" data-toggle="tooltip" data-placement="top" title="Editar Datos"><i class="fas fa-edit"></i> </a>
                              @endcan
                              @can('complementos.destroy')  
                                <a href="#" data-id="{{$calle->id}}" class="btn btn-sm btn-flat btn-outline-danger btnDelete" data-toggle="modal" data-target="#delete"  data-toggle="tooltip" data-placement="top" title="Eliminar Registro">
                  ...
                  <div>
                    <strong>
                      <?php echo  'Mostrando ' . $calles->firstItem() . ' a ' . $calles->lastItem() . ' de ' . $calles->total() . ' registros'; ?> 
                       {{ $calles->appends(Request::only(['tipo','buscarpor']))->links() }}
                    </strong>  
                <!--</div>-->
              </div>
              </div>
...
@section('js')
  <script type="text/javascript">
    ...
    $('.btnDelete').on('click', function(){
      var c = $(this).data('id');
      $('#frmdelete').attr('action', '{{asset('calles')}}/'+c);
