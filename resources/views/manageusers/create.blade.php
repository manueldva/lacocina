                    ...
                    <!-- form start -->
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Eje: Juan Perez" value="{{ old('name') }}">
                        </div>
                        @error('name')
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Eje: jperez" value="{{ old('username') }}">
                        </div>
                        @error('username')
                          <div class="alert alert-info" role="alert">
                            {{ $message }}
