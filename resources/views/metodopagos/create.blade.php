...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Nuevo M. Pago</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <!-- form start -->
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" placeholder="Eje: Semanal" value="{{ old('descripcion') }}">
                        </div>
                        @error('descripcion')
