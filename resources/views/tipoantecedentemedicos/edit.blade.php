...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="{{ route('tipoantecedentemedicos.update',$tipoantecedentemedico->id) }}" method="POST">
            @csrf
            @method('PUT')
              <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" value="{{ $tipoantecedentemedico->descripcion }}">
                        </div>
                        @error('descripcion')
                        ...
                        <div class="form-group">
                          ...
                          <select  id="activo" name="activo" class="form-control  @error('activo') is-invalid @enderror">
                            <option value="1" {{ $tipoantecedentemedico->activo == '1' ? 'selected' : '' }}>Activo</option>
                            <option value="0" {{ $tipoantecedentemedico->activo == '0' ? 'selected' : '' }}>Inactivo</option>
                        </select>
                        </div>
                        @error('activo')
                          <div class="alert alert-info" role="alert">
