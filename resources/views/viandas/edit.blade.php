...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@if($show == 1) Ver @else Editar @endif Vianda</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="{{ route('viandas.update',$vianda->id) }}" method="POST">
            @csrf
            @method('PUT')
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card card-default">
                    ...
                    <!-- form start -->
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label>Detalle</label>
                          <textarea id= "detalle" name="detalle" class="form-control" rows="2" placeholder="Ingrese un detalle">{{ $vianda->detalle }}</textarea>
                        </div>
                        @error('detalle')
                          <div class="alert alert-info" role="alert">
                            {{ $message }}
                        ...
                        <div class="form-group">
                          ...
                          <select  id="activo" name="activo" class="form-control  @error('activo') is-invalid @enderror">
                            <option value="1" {{ $vianda->activo == '1' ? 'selected' : '' }}>Activo</option>
                            <option value="0" {{ $vianda->activo == '0' ? 'selected' : '' }}>Inactivo</option>
                        </select>
                        </div>
                        @error('activo')
                          <div class="alert alert-info" role="alert">
